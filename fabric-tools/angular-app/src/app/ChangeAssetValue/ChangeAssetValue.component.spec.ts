...
describe('ChangeAssetValueComponent', () => {
  ...
  let mockChangeAssetValueService;
  let mockDataService

  beforeEach(async(() => {

    mockChangeAssetValueService = sinon.createStubInstance(ChangeAssetValueService);
    mockChangeAssetValueService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ChangeAssetValueService, useValue: mockChangeAssetValueService },
